...
import './BlueWaveBottom.css';

const BlueWaveBottom = (props) => {
  return (
    <div className="wave-container-bottom">
      <div className="blue-wave-bottom">
          <svg width="1440" height="3193" viewBox="0 0 1440 3193" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
